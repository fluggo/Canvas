...
void video_get_frame_f16_gl( video_source *source, int frame_index, rgba_frame_f16 *frame );
void video_get_frame_f32_gl( video_source *source, int frame_index, rgba_frame_f32 *frame );
