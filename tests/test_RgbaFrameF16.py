...
class test_RgbaFrameF16(unittest.TestCase):
    def test_solid(self):
        ...
        self.assertEqual(frame.current_data_window, box2i(0, 0, 2, 2))
        self.assertEqual(frame.full_data_window, box2i(0, 0, 3, 3))
        ...
        self.assertEqual(frame2.current_data_window, box2i(0, 0, 1, 1))
        self.assertEqual(frame2.full_data_window, box2i(-1, -1, 1, 1))
